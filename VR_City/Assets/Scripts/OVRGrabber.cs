...
public class OVRGrabber : MonoBehaviour
{
    ...
    public static OVRGrabber instance;
    ...
    void OnUpdatedAnchors()
    {
        ...
        Grabbedpos(m_lastPos, m_lastRot);
    ...
    protected virtual void Grabbedpos(Vector3 pos, Quaternion rot)
    {
        objpos = pos + rot * m_grabbedObjectPosOff;
        //Debug.Log(objpos);
        //return objpos;
    }
